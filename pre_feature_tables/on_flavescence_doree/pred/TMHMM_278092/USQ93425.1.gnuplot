...
set key below
set title "TMHMM posterior probabilities for USQ93425.1"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_278092/USQ93425.1.eps"
plot "./TMHMM_278092/USQ93425.1.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
