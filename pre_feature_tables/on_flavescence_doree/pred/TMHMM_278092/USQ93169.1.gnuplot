...
set arrow from 110,1.11 to 118,1.11 nohead lt 4 lw 10
set arrow from 119,1.09 to 141,1.09 nohead lt 1 lw 40
set arrow from 142,1.07 to 152,1.07 nohead lt 3 lw 10
set arrow from 153,1.09 to 175,1.09 nohead lt 1 lw 40
set arrow from 176,1.11 to 197,1.11 nohead lt 4 lw 10
...
set arrow from 256,1.11 to 258,1.11 nohead lt 4 lw 10
...
set arrow from 324,1.11 to 333,1.11 nohead lt 4 lw 10
set key below
set title "TMHMM posterior probabilities for USQ93169.1"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_278092/USQ93169.1.eps"
plot "./TMHMM_278092/USQ93169.1.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
