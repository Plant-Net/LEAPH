...
set arrow from 96,1.07 to 110,1.07 nohead lt 3 lw 10
set arrow from 111,1.09 to 133,1.09 nohead lt 1 lw 40
set arrow from 134,1.11 to 152,1.11 nohead lt 4 lw 10
...
set key below
set title "TMHMM posterior probabilities for 2570379038"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_62292/2570379038.eps"
plot "./TMHMM_62292/2570379038.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
