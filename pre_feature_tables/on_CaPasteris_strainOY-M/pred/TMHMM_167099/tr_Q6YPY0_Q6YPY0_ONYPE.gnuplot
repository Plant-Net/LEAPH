...
set key below
set title "TMHMM posterior probabilities for tr|Q6YPY0|Q6YPY0_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YPY0_Q6YPY0_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YPY0_Q6YPY0_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
