...
set arrow from 314,1.07 to 351,1.07 nohead lt 3 lw 10
set arrow from 352,1.09 to 374,1.09 nohead lt 1 lw 40
set arrow from 375,1.11 to 413,1.11 nohead lt 4 lw 10
set key below
set title "TMHMM posterior probabilities for tr|Q6YR02|Q6YR02_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YR02_Q6YR02_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YR02_Q6YR02_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
