...
set arrow from 170,1.07 to 210,1.07 nohead lt 3 lw 10
...
set arrow from 276,1.07 to 289,1.07 nohead lt 3 lw 10
set key below
set title "TMHMM posterior probabilities for tr|Q2NIU5|Q2NIU5_AYWBP"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_145242/tr_Q2NIU5_Q2NIU5_AYWBP.eps"
plot "./TMHMM_145242/tr_Q2NIU5_Q2NIU5_AYWBP.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
