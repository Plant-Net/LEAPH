...
set key below
set title "TMHMM posterior probabilities for tr|B1V989|B1V989_PHYAS"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_187945/tr_B1V989_B1V989_PHYAS.eps"
plot "./TMHMM_187945/tr_B1V989_B1V989_PHYAS.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
