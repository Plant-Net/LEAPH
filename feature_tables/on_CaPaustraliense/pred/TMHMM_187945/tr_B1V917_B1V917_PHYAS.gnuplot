...
set arrow from 73,1.07 to 125,1.07 nohead lt 3 lw 10
set arrow from 126,1.09 to 148,1.09 nohead lt 1 lw 40
set arrow from 149,1.11 to 152,1.11 nohead lt 4 lw 10
...
set arrow from 304,1.07 to 361,1.07 nohead lt 3 lw 10
set arrow from 362,1.09 to 384,1.09 nohead lt 1 lw 40
set arrow from 385,1.11 to 575,1.11 nohead lt 4 lw 10
set key below
set title "TMHMM posterior probabilities for tr|B1V917|B1V917_PHYAS"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_187945/tr_B1V917_B1V917_PHYAS.eps"
plot "./TMHMM_187945/tr_B1V917_B1V917_PHYAS.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
