...
set arrow from 166,1.07 to 193,1.07 nohead lt 3 lw 10
set key below
set title "TMHMM posterior probabilities for sp|B1V944|Y141_PHYAS"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_187945/sp_B1V944_Y141_PHYAS.eps"
plot "./TMHMM_187945/sp_B1V944_Y141_PHYAS.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
