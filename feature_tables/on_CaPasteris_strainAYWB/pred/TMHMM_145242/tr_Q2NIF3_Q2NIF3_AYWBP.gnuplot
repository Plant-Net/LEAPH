...
set key below
set title "TMHMM posterior probabilities for tr|Q2NIF3|Q2NIF3_AYWBP"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_145242/tr_Q2NIF3_Q2NIF3_AYWBP.eps"
plot "./TMHMM_145242/tr_Q2NIF3_Q2NIF3_AYWBP.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
