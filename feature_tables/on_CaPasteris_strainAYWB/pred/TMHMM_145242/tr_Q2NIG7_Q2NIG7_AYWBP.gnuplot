...
set key below
set title "TMHMM posterior probabilities for tr|Q2NIG7|Q2NIG7_AYWBP"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_145242/tr_Q2NIG7_Q2NIG7_AYWBP.eps"
plot "./TMHMM_145242/tr_Q2NIG7_Q2NIG7_AYWBP.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
