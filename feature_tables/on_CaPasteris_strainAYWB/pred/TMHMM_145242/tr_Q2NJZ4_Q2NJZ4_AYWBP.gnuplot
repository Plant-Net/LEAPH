...
set key below
set title "TMHMM posterior probabilities for tr|Q2NJZ4|Q2NJZ4_AYWBP"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_145242/tr_Q2NJZ4_Q2NJZ4_AYWBP.eps"
plot "./TMHMM_145242/tr_Q2NJZ4_Q2NJZ4_AYWBP.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
