...
set arrow from 220,1.11 to 282,1.11 nohead lt 4 lw 10
set key below
set title "TMHMM posterior probabilities for tr|Q6YPR5|Q6YPR5_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YPR5_Q6YPR5_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YPR5_Q6YPR5_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
