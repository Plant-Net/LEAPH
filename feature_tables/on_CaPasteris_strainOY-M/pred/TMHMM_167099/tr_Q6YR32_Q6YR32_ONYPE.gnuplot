...
set key below
set title "TMHMM posterior probabilities for tr|Q6YR32|Q6YR32_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YR32_Q6YR32_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YR32_Q6YR32_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
