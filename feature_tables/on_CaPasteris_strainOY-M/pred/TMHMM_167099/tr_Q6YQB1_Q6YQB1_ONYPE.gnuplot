...
set arrow from 95,1.07 to 128,1.07 nohead lt 3 lw 10
set key below
set title "TMHMM posterior probabilities for tr|Q6YQB1|Q6YQB1_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YQB1_Q6YQB1_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YQB1_Q6YQB1_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
