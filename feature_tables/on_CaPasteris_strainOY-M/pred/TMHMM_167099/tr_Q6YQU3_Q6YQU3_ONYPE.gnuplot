...
set arrow from 128,1.11 to 161,1.11 nohead lt 4 lw 10
set arrow from 162,1.09 to 184,1.09 nohead lt 1 lw 40
set arrow from 185,1.07 to 190,1.07 nohead lt 3 lw 10
...
set key below
set title "TMHMM posterior probabilities for tr|Q6YQU3|Q6YQU3_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YQU3_Q6YQU3_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YQU3_Q6YQU3_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
