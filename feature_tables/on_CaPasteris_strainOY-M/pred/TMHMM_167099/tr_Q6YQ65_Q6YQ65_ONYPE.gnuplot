...
set key below
set title "TMHMM posterior probabilities for tr|Q6YQ65|Q6YQ65_ONYPE"
set yrange [0:1.2]
set size 2., 1.4
#set xlabel "position"
...
set output "./TMHMM_167099/tr_Q6YQ65_Q6YQ65_ONYPE.eps"
plot "./TMHMM_167099/tr_Q6YQ65_Q6YQ65_ONYPE.plp" using 1:4 title "transmembrane" with impulses lt 1 lw 2, \
